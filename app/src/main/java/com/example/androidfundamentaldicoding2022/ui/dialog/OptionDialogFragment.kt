package com.example.androidfundamentaldicoding2022.ui.dialog
...
class OptionDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnChoose.setOnClickListener{
            val chceckedRadioButtonId = rgOptions.checkedRadioButtonId

            if (chceckedRadioButtonId != -1) {
                var coach: String? = when (chceckedRadioButtonId) {
                ...
                optionDialogListner?.onOptionChosen(coach)
                dialog?.dismiss()
            }
